...
def negative_samples(input_length, input_dim, output_length, output_dim, hidden_dim, ns_amount, learning_rate, drop_rate):
    ...
    q_encoder_output = Dropout(rate=drop_rate)(q_encoder_output)
    decoder = Bidirectional(GRU(hidden_dim), merge_mode="ave")
    r_decoder_output = decoder(fixed_r_decoder_input)
    r_decoder_output = Dropout(rate=drop_rate)(r_decoder_output)
...
if __name__ == '__main__':
    ...
    train(w2v_model, qa_path, doc_path)